...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _activate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! /activate */ \"./activate.js\");\n\n\nconst increment = function (e) {\n\te.preventDefault();\n\n\tlet el = e.target;\n\tlet activateNum = parseInt(el.getAttribute('data-activate-count'));\n\n\tactivateNum += 1;\n\n\tel.setAttribute('data-activate-count', activateNum);\n};\n\n\n// NodeList\nconst nodelist = document.querySelectorAll('.js-activate-nodelist');\nObject(_activate__WEBPACK_IMPORTED_MODULE_0__[\"activate\"])(nodelist, increment);\n\n// Node\nconst node = document.querySelector('.js-activate-node');\nObject(_activate__WEBPACK_IMPORTED_MODULE_0__[\"activate\"])(node, increment);\n\n// string\nconst string = '.js-activate-string';\nObject(_activate__WEBPACK_IMPORTED_MODULE_0__[\"activate\"])(string, increment);\n\n\n// Element types\nObject(_activate__WEBPACK_IMPORTED_MODULE_0__[\"activate\"])('.js-activate-types', increment);\n\n\n// Deactivate\nconst counter = document.querySelector('.js-deactivate-counter');\n\nObject(_activate__WEBPACK_IMPORTED_MODULE_0__[\"activate\"])('.js-deactivate-on', () => Object(_activate__WEBPACK_IMPORTED_MODULE_0__[\"activate\"])(counter, increment));\nObject(_activate__WEBPACK_IMPORTED_MODULE_0__[\"activate\"])('.js-deactivate-off', () => Object(_activate__WEBPACK_IMPORTED_MODULE_0__[\"deactivate\"])(counter, increment));\n\n\n//# sourceURL=webpack:///./docs/assets/js/src/main.js?");
